...
parser.add_argument("--out", type=str,
                    default="examples/inpaint/case1_out_test_pytorch_new.png", help="path for the output file")
...
def main():
    ...
    model = DeepFillV2InPaint(checkpoint_path=args.checkpoint).to(device=device)
